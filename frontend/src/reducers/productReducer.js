...
export const itemsReducer = (state = { items: [] }, action) => {
  switch (action.type) {
    case ALL_PROCESSORS_REQUEST:
    case ALL_GRAPHIC_CARDS_REQUEST:
    case COMPATIBLE_MOTHERBOARDS_REQUEST:
    case COMPATIBLE_RAM_REQUEST:
    case COMPATIBLE_STORAGE_REQUEST:
    ...
    case ALL_GRAPHIC_CARDS_SUCCESS:
    case COMPATIBLE_MOTHERBOARDS_SUCCESS:
    case COMPATIBLE_RAM_SUCCESS:
    case COMPATIBLE_STORAGE_SUCCESS:
    ...
    case ALL_PROCESSORS_FAILURE:
    case ALL_GRAPHIC_CARDS_FAILURE:
    case COMPATIBLE_MOTHERBOARDS_FAILURE:
    case COMPATIBLE_RAM_FAILURE:
    case COMPATIBLE_STORAGE_FAILURE:
      return {
        ...state,
        loading: false,
        error: action.payload
